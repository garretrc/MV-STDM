...
y_strat_missing[t_s1, s1_uni] = NA

y_full_missing = y_full_strat
y_full_missing[t_s1, s1_multi] = NA
...
save(results_uni,file = 'data/results/results_s1_uni_84_95_1500.RData')
rm(results_uni)
gc()
...
save(results_rw,file = 'data/results/results_s1_rw_84_95_1500.RData')
rm(results_rw)
gc()
...
save(results_multi,file = '/data/results/results_s1_multi_84_95_1500.RData')
rm(results_multi)
gc()
